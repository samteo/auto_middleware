...
> 1. **ASK THE USER**: "I've detected a project initialization template. Would you like me to set up a new project?"
> 2. **IF YES**: Follow the initialization workflow below
> 3. **CREATE**: A customized CLAUDE.md based on user's responses
> 4. **DELETE**: This template file after successful setup
